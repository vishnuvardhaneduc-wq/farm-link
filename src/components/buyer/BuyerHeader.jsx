      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div>
          ...
          <p className="text-[11px] text-[#6d6d6d] mt-1 font-mono uppercase tracking-widest">
            Institutional Procurement Desk • Regional Dock Delivery • Active Window: 06:00 – 18:00 IST
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          <form
            onSubmit={(e) => {
              ...
              if (q) window.location.href = `/buyer/products/results?q=${encodeURIComponent(q)}`
            }}
          ...
          >
            ...
            <input
              name="search"
              type="text"
              placeholder="Search crops, vegetables, FPO suppliers..."
          ...
          <Link
            ...
            className="flex items-center gap-2 px-5 py-2 rounded-[100px] bg-[#1b6e53] text-[#ffffff] text-xs font-semibold hover:bg-[#165a44] transition shrink-0 shadow-sm uppercase tracking-wider cursor-pointer font-mono"
          >
            <span className="material-symbols-outlined text-[16px]">add_circle</span>
            <span className="hidden sm:inline">+ Post Demand</span>
