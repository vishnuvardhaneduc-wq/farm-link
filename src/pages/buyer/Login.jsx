...
export default function BuyerLogin() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#f1efdf] font-sans text-[#212529] selection:bg-[#e8fe85] selection:text-[#1b6e53]">
      ...
      <AuthHeader portalTitle="Buyer Enterprise Desk" backTo="/" backLabel="Back to Launch Portal" />
          ...
          <div className="w-full md:w-5/12 bg-[#e6ecd5] p-8 sm:p-10 flex flex-col justify-between relative border-b md:border-b-0 md:border-r border-[#c3cda7]/60">
            <div className="relative z-10 flex flex-col">
              ...
              <h1 className="font-editorial text-3xl sm:text-4xl text-[#00372a] font-normal leading-[1.2] tracking-tight mb-3">
                Source verified produce directly from FPOs.
              </h1>
              <p className="font-sans text-xs sm:text-sm text-[#353535] font-normal leading-relaxed mb-6">
                Discover FPO suppliers, send procurement requests, compare offers, and manage orders with end-to-end transparency.
              </p>
              ...
              <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      <span className="block font-sans text-xs font-bold text-[#212529]">
                        Verified FPO Suppliers
                      </span>
                      <span className="block font-sans text-[11px] text-[#6d6d6d] mt-0.5 leading-snug">
                        Direct connection to certified grower cohorts & harvest forecasts
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-[16px] bg-[#ffffff] border border-[#c3cda7]/70 shadow-2xs">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      <span className="block font-sans text-xs font-bold text-[#212529]">
                        Tenders & Indent Bidding
                      </span>
                      <span className="block font-sans text-[11px] text-[#6d6d6d] mt-0.5 leading-snug">
                        Publish tonnage demands & lock standardized APMC contracts
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-[16px] bg-[#ffffff] border border-[#c3cda7]/70 shadow-2xs">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      <span className="block font-sans text-xs font-bold text-[#212529]">
                        Cold-Chain & T+0 Escrow
                      </span>
                      <span className="block font-sans text-[11px] text-[#6d6d6d] mt-0.5 leading-snug">
                        CV quality assay grading, dispatch telemetry & escrow protection
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="pt-6 mt-6 flex items-center gap-2 text-[#1b6e53] border-t border-[#c3cda7]/50 relative z-10 text-xs">
              ...
              <span className="font-mono text-[11px] font-medium">
                256-bit Encrypted • Institutional Buyer Procurement Node
              </span>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="mb-7">
                ...
                <p className="font-sans text-xs sm:text-sm text-[#6d6d6d] leading-relaxed">
                  Sign in to publish procurement demands, compare FPO quotes, and track bulk deliveries.
                </p>
              </div>

              {/* Login Form */}
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Buyer ID or Email Field */}
                <div className="space-y-1.5">
                  <label
                    htmlFor="buyer-identifier"
                    className="block font-sans text-xs font-semibold tracking-wide uppercase text-[#212529]"
                  >
                    Buyer ID or Official Email Address
                  </label>
                ...
                <div className="pt-1">
                  <label className="flex items-center gap-2.5 cursor-pointer select-none">
                    ...
                    <span className="font-sans text-xs text-[#353535]">
                      Keep this procurement terminal signed in (30 days)
                    </span>
                  </label>
                </div>
                  ...
                  >
                    {isLoading ? (
                      <>
                        ...
                        <span>Authenticating Buyer Terminal...</span>
                      </>
                    ) : (
                      <>
                        <span>Sign In to Buyer Desk</span>
              ...
              <div className="mt-6 text-center text-xs">
                <span className="text-[#6d6d6d]">New institutional commercial buyer?</span>
                <Link
                  to="/buyer/register"
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <p className="font-sans text-xs font-bold text-[#1b6e53] leading-snug">
                    Enterprise Procurement Guarantee
                  </p>
                  <p className="font-sans text-[11px] text-[#353535] mt-1 leading-relaxed">
                    All listed suppliers are certified FPO legal entities registered under NABARD and SFAC guidelines with verified assay testing facilities.
                  </p>
                </div>
              </div>
            </div>
